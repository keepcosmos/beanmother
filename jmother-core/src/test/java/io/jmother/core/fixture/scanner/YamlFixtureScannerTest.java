...
public class YamlFixtureScannerTest {
    ...
    public void testSingleFixtureFile() {
        ...
        List<File> files = scanner.scan(new Location("fixtures/animals/pet/dog.yml"));
    ...
    public void testFilesystemPath() {
        FixtureScanner scanner = new YamlFixtureScanner(classLoader);
        List<File> files = scanner.scan(new Location("filesystem:src/test/resources/fixtures/animals/pet/dog.yml"));
